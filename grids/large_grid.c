...
#define CELL_WIDTH 37     // Width of each cell
#define CELL_HEIGHT 23    // Height of each cell
...
void place_imgs(SDL_Renderer *renderer, int screen_x, int screen_y) {
    ...
    // place ladder
    draw_img(renderer, ladder_texture, 18, 1, 20, 3, screen_x, screen_y, 1, 1, 90);
    ...
    draw_img(renderer, ladder_texture5, 4, 10, 6, 12, screen_x, screen_y, 1, 1, 0);

        // place snakes
    draw_img(renderer, snake_texture, 30, 0, 34, 4, screen_x, screen_y, 1, 1, 90);
    ...
    draw_img(renderer, snake_texture5,  6, 8, 9, 11, screen_x, screen_y, 1, 1, 0);
